        ...
        <div class="col-md-2">
            <div class="row">
                <div class="btn-group-vertical" role="group" aria-label="...">
                    ...
                    <button type="button" class="btn btn-default optionPanel" >Agregar Categoría</button>
                    <button type="button" class="btn btn-default optionPanel" >Agregar Subcategoría</button>
